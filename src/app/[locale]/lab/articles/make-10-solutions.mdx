...
I recently decided to automate the solution for every integer from `0000` to `9999`. I wrote a solver in Rust (a real mess of a code) to see how many of these combinations could actually be solved given a specific set of operations.
